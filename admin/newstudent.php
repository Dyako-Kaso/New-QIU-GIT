...

{
    ...
    $update_query = mysqli_query($database,"INSERT INTO student_accounts (first_name,last_name,Enrollment_No,Password,department) VALUES ('$FirstName','$LastName','$Enrollment_No','$Password','$Department')");
...
<head>
    ...
    if (confirm("Are you sure you want to Add the Student?")) 
    {
        form.submit();
    }
    else
                    ...
                    <form name="admin" method="post">
                        <div class="form-row m-b-55">
                            ...
                            <!-- <div class="value"> -->
                                ...
                                <div class="col-2" style="margin-top:40px;">
                                    <div class="input-group-desc">
                                        <select class="input--style-5" name="Department" required="">
                                        ...
                                        <label class="label--desc">Department</label>
                                    </div>
                                </div>
