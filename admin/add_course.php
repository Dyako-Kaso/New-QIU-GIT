            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form name="admin" method="post">
                        ...
                        <div class="col-2">
                                        <div class="input-group-desc">
                                        <input class="input--style-5" type="number" min="1" max="7" name="Course_Credit" value="" required="">
                                        </div>
                                    </div>
                                </div>  
                                <div class="form-row">
                            ...
                            <div class="col-2" style="margin-top:50px;margin-left:120px;"> <!-- Create a new column for the submit button -->
