...
if(isset($_POST['submit']))
{
  ...
  $query=mysqli_query($database,"SELECT * FROM student_accounts WHERE Enrollment_No='$Enrollment_No' and Password='$Password'");
...
<head>
  ...
  <title>Student Registration // Qaiwan International University</title>
    ...
    <nav class="navbar navbar-ct-transparent navbar-fixed-top" role="navigation-demo" id="register-navbar">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://www.uniq.edu.iq/">Qaiwan International University</a>
        </div>
